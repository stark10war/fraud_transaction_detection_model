...
```{r}
xgb_cv$evaluation_log %>% ggplot(aes(x = iter ,y = train_error_mean, colour = 'blue')) 
                          + geom_line() + geom_line(aes(y= test_error_mean , colour = 'red'))
...
```{r}
fit$evaluation_log %>% ggplot(aes(x = iter ,y = train_set_error, colour = 'blue')) + geom_line() + geom_line(aes(y= test_set_error , colour = 'red'))
```
